...
json_dict = {
    ...
    "service": [
        ...
        {
            "type": "Metadata",
            "serviceEndpoint": "http://localhost:5000/api/v1/aquarius/assets/ddo/did:op"
                               ":0c184915b07b44c888d468be85a9b28253e80070e5294b1aaed81c2f0264e430",
            "metadata": {
                "base": {
                    ...
                    "links": [
                        {
                            "url": "http://data.ceda.ac.uk/badc/ukcp09/data/gridded-land-obs"
                                   "/gridded-land-obs-daily/"
                        },
                        {
                            "url": "http://data.ceda.ac.uk/badc/ukcp09/data/gridded-land-obs"
                                   "/gridded-land-obs-averages-25km/"
                        },
                        {
